...
import { CommissionModeCreatedEvent } from './commissionmodecreated.event';
import { CommissionModeUpdatedEvent } from './commissionmodeupdated.event';
import { CommissionModeDeletedEvent } from './commissionmodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'commission-mode-created': createEventDefinition('commission-mode-created', CommissionModeCreatedEvent, EVENT_DEFINITION_OVERRIDES['commission-mode-created']),
  'commission-mode-updated': createEventDefinition('commission-mode-updated', CommissionModeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['commission-mode-updated']),
  'commission-mode-deleted': createEventDefinition('commission-mode-deleted', CommissionModeDeletedEvent, EVENT_DEFINITION_OVERRIDES['commission-mode-deleted']),
