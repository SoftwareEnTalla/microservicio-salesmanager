...
@Injectable()
export class SalesmanagerMerchantContractStatusAuthGuard implements CanActivate {
  private readonly logger = new Logger(SalesmanagerMerchantContractStatusAuthGuard.name);
