...
@Injectable()
export class SalesmanagerMerchantContractStatusGuard implements CanActivate {
  private readonly logger = new Logger(SalesmanagerMerchantContractStatusGuard.name);
