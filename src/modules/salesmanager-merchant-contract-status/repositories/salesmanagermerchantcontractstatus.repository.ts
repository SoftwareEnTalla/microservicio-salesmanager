...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class SalesmanagerMerchantContractStatusRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[SalesmanagerMerchantContractStatus[], number]> {
      logger.info('Ready to findByField SalesmanagerMerchantContractStatus on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of SalesmanagerMerchantContractStatus with id:  was finded on repository:', instance);
