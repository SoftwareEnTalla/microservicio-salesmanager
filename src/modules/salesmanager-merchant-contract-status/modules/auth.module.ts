...
@Module({
  controllers: [SalesmanagerMerchantContractStatusCommandController],
  providers: [
  ...
  exports: [SalesmanagerMerchantContractStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthSalesmanagerMerchantContractStatusModule {}
