...
import { SalesmanagerMerchantContractStatusCreatedEvent } from './salesmanagermerchantcontractstatuscreated.event';
import { SalesmanagerMerchantContractStatusUpdatedEvent } from './salesmanagermerchantcontractstatusupdated.event';
import { SalesmanagerMerchantContractStatusDeletedEvent } from './salesmanagermerchantcontractstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'salesmanager-merchant-contract-status-created': createEventDefinition('salesmanager-merchant-contract-status-created', SalesmanagerMerchantContractStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['salesmanager-merchant-contract-status-created']),
  'salesmanager-merchant-contract-status-updated': createEventDefinition('salesmanager-merchant-contract-status-updated', SalesmanagerMerchantContractStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['salesmanager-merchant-contract-status-updated']),
  'salesmanager-merchant-contract-status-deleted': createEventDefinition('salesmanager-merchant-contract-status-deleted', SalesmanagerMerchantContractStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['salesmanager-merchant-contract-status-deleted']),
