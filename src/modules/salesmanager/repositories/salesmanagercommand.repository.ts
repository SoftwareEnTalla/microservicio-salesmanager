...
export class SalesManagerCommandRepository implements IEventHandler<BaseEvent>{
  ...
  async create(entity: SalesManager): Promise<SalesManager> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvt1 = new SalesManagerCreatedEvent(result.id, {
        instance: result,
        metadata: {
  ...
  async bulkCreate(entities: SalesManager[]): Promise<SalesManager[]> {
    ...
    if (this.shouldPublishEvent()) {
      const __dualEvts2 = result.map((el)=>new SalesManagerCreatedEvent(el.id, {
        instance: el,
        metadata: {
  ...
  async update(
    ...
    if(instance && this.shouldPublishEvent()) {
      ...
      const __dualEvt3 = new SalesManagerUpdatedEvent(instance.id, {
          instance: instance,
          metadata: {
    ...
    for (const entity of entities) {
      if (entity.id) {
        ...
        if (updatedEntity) {
          ...
          if (this.shouldPublishEvent()) {
            const __dualEvt4 = new SalesManagerUpdatedEvent(updatedEntity.id, {
  ...
  async delete(id: string): Promise<DeleteResult> {
     ...
     if (this.shouldPublishEvent()) {
       ...
       const __dualEvt5 = new SalesManagerDeletedEvent(id, {
        instance: entity,
        metadata: {
